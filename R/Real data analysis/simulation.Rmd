...
LOOIC is the same whether set alphaR40 as positive or real, as the histograms indicate the left tail of alphaR40. So here only show discuss the case when it is positive.

```{r}
rbind(allalpha = dmg_loo$estimates[3,1],
      noalpha = nondmg_loo$estimates[3,1],
