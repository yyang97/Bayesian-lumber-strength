...
setwd("F:/study/Research/Bayesian-lumber-strength/R/Single simulation/low damage")
...
alpha_R <-c(0.65,1.79,1.26)
alpha_T <- c(85.69,102.71,64.76)
...
rho_nondmg[i] <- summary(nondmg_fit)[[1]][5,1]
